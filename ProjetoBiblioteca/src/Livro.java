...
public class Livro {
	...
	public Livro(String titulo, String autor, String categoria, int anoPubli, int posEstante, int posPrateleira) {
		super(); //construtor da classe pai (object)
	...
	public String exibirInfo() {
		String mensagem;
		mensagem = "Livro: "+getTitulo()+" / "+autor+" ("+anoPubli+")\n"+
					"Categoria: "+categoria+"\nPosição: Estante "+posEstante+
					" - Prateleira "+posPrateleira+"\n"+
					((disponivel) ? "DISPONIVEL":"EMPRESTADO");
		return mensagem;
	}
	
	//troquei o setDiponivel pelos métodos abaixo
